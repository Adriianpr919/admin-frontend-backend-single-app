            ...
            <div className="col-lg-12 order-last order-lg-first">
              <div className="about-text-wrap">
                ...
                <p style={{ textAlign: "justify" }} lang="es"><hr className="my-10" />
                  ...
                  <br />
                  Cambios a través de "sitio web https://nuryvalenzuelajoyeria.netlify.app/":
                  <br />
                  Si deseas hacer el cambio a través de sitio web https://nuryvalenzuelajoyeria.netlify.app/, (Dentro de Villavicencio (Meta) 2 días máximo) a nivel nacional 6 días hábiles y a nivel internacional de 10 a 20 días hábiles, luego de haber recibido el producto, debes ponerte en contacto con el área de Servicio al cliente de +57-3133966349 (en horario de lunes a viernes de 9am-6pm), a través de nuestro correo: nuryvalenzuelajoyeria@gmail.com, o en nuestro sitio web https://nuryvalenzuelajoyeria.netlify.app/ en el formulario de ‘Contáctanos’.
                  <br />
                  ...
                  <br />
                  Bono o nota crédito para realizar una nueva compra sitio web https://nuryvalenzuelajoyeria.netlify.app/ (este bono tendrá vigencia de seis (6) meses). Devolución del dinero únicamente acorde al derecho de retracto consagrado por la ley 1480 de 2011 art. 47. Para hacer la devolución del envío DEBES utilizar el mismo empaque en que te entregamos tu pedido.
                  <br />
                  ...
                  <br />
                  Bono o nota crédito para realizar una nueva compra en sitio web https://nuryvalenzuelajoyeria.netlify.app/ será enviado a tu correo dos (2) días hábiles después recibido el producto en nuestra bodega.
                  <br />
